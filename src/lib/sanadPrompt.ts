...
- When asked for an extreme or a ranking (cheapest, largest, closest to a budget, shortest on the market, etc.), check every row of the PORTFOLIO table before answering — don't answer from the first few rows you happen to notice. State the single best match, and a couple of close runners-up if it helps the investor compare.
